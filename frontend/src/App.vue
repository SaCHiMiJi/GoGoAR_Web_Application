  ...
  <div id="app">
    <nav class="bg-[#322653] border-gray-200 sticky top-0 z-[100]">
      <div class="w-full flex flex-wrap items-center justify-between p-4">
        ...
        <!-- Navigation Buttons -->
        <div
          class="hidden w-full md:block md:w-auto flex flex-col"
          id="navbar-default"
        >
          <RouterLink to="/discovery">
            <button
              class="mx-4 text-white bg-[#322653] hover:bg-white hover:text-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 focus:outline-none"
            >
              Discovery
            </button>
          </RouterLink>
          ...
          <button
            ...
            ref="button"
            type="button"
            class="mx-4 border-2 border-white text-white bg-[#322653] hover:bg-white hover:text-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 focus:outline-none"
            id="user-menu-button"
            aria-expanded="false"
          >
          ...
          <div
            ...
            ref="dropdown"
            class="absolute right-0 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow"
            id="user-dropdown"
          >
            <div class="px-4 py-3">
...
<script>
const clearUserData = function (context) {
  context.clearData();
};
export default {
  data() {
  ...
  mounted() {
    ...
    this.emitter.on("signout", () => clearUserData(this));
  },
  beforeUnmount() {
    // Updated for Vue 3
    document.removeEventListener("click", this.handleClickOutside);
    this.emitter.off("signout"); // Remove event listener to avoid memory leaks
  },
};
</script>
