<template>
  <div class="align-self-center;"> 
        ...
        <div class="gap-8 items-center py-8 px-4 max-w-screen-2xl xl:gap-16 md:grid md:grid-cols-2 lg:px-6 max-h-screen-xl" v-if="!isAssignmentSubmit">
          ...
          <div class="sm:relative sm:flex-grow sm:flex sm:items-center sm:justify-center sm:self-start">
    ...
    methods: {
        ...
        submitAssignment() {
            ...
            if(this.assignmentName === null || this.assignmentName === "" || this.getInstructionAmount === 0) {
              return useToast().error("Please complete the assignment name or create the instruction atleast one.");
            }
