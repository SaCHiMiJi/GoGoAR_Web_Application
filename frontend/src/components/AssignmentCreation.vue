      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
          <button
            ...
            type="button"
            class="absolute top-3 right-2.5 text-gray-400hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center"
          >
            <svg
              class="w-3 h-3"
              aria-hidden="true"
          ...
          <div class="p-4 md:p-5 text-center">
            <h3 class="my-5 text-lg font-normal text-gray-500">
              Are you sure you want to proceed? Please confirm that all details
              and instructions are complete and accurate before submitting.
            </h3>
            <button
              v-on:click="submitAssignment"
              type="button"
              class="text-white bg-[#50C878] hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center"
            >
              Yes
            </button>
            <button
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-4 md:p-5 text-center">
            ...
            <button
              v-on:click="deleteInstruction(focusDeleteInstruction)"
              type="button"
      ...
      <div class="items-start">
        ...
        <div class="bg-[#322653] rounded-md p-8">
          ...
          <textarea
            ...
            id="message"
            rows="1"
            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 mb-2"
          ></textarea>
        ...
        <div class="mb-5 bg-[#EDE7F0] rounded-md p-8">
          ...
          <div v-if="!formCreating">
            <div v-for="[key] in steps" :key="key">
              <div
                class="p-4 rounded-lg bg-gray-100 shadow-md flex items-center justify-between mb-2"
              >
                ...
                <div class="flex items-center space-x-2 flex-shrink-0">
                  <button
                    ...
                    v-on:click="openInstructionForm(key)"
                  >
                    <v-lazy-image class="w-5 h-5" src="/edit_image.svg" />
                  </button>
                  <button
                    @click="focusDeleteInstruction = key"
                    class="text-gray-700 hover:text-gray-900"
                  >
                  ...
                  <div class="flex flex-col space-y-1 flex-shrink-0">
                    <button
                      class="text-gray-700 hover:text-gray-900"
                      v-on:click="moveInstructionUp(key)"
                    >
                      <svg
                        class="w-5 h-5"
                        fill="none"
                    ...
                    <button
                      class="text-gray-700 hover:text-gray-900"
                      v-on:click="moveInstructionDown(key)"
                    >
                      <svg
                        class="w-5 h-5"
                        fill="none"
          ...
          <div class="block bg-[#EDE7F0] px-16" v-else>
            ...
            <div
              v-if="
                assignmentFunction !== 'context' && assignmentFunction !== null
              "
              class="pb-4"
            >
            ...
            <div class="flex justify-center">
              <button
                ...
                class="items-center text-white bg-[#D65F5F] hover:bg-white-800 focus:ring-4 focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 m-6 p-8"
              >
                Cancel
              </button>
              <button
                class="items-center text-white bg-[#50C878] hover:bg-white-800 focus:ring-4 focus:ring-white-300 font-medium rounded-lg text-sm px-5 py-2.5 m-6 p-8"
                @click="saveInstructionForm"
              >
                Save
              </button>
            </div>
      ...
      >
        ...
        <div class="text-lg">
          ...
          <div class="relative bg-[#322653] mb-6 p-2">
            ...
            <button
              v-on:click="copyLink(mobileAppURL)"
            ...
            <div v-for="[key] in steps" :key="key">
              ...
              >
                <div class="flex items-center">
                  <span
                    class="text-gray-700 text-xs font-medium px-2 py-1 rounded-full mr-2"
                    >{{ key }}</span
                  >
                  <span class="text-lg font-medium text-purple-700">{{
                    getStepFunctionDetails(key)
        ...
        <div class="w-full max-w-[26rem]">
          <div class="relative">
            ...
            >
              ...
              >
                <svg
                  class="w-3 h-3 text-blue-700 me-1.5"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 16 12"
      ...
      areas: [
        {
          alt: "input1",
          title: "input1",
          coords: "200,452,155,413",
          shape: "rect",
        },
        {
          alt: "input2",
          title: "input2",
          coords: "200,454,252,409",
          shape: "rect",
        },
        {
          alt: "input3",
          title: "input3",
          coords: "252,407,298,454",
          shape: "rect",
        },
        {
          alt: "input4",
          title: "input4",
          coords: "299,414,349,451",
          shape: "rect",
        },
        {
          alt: "output1",
          title: "output1",
          coords: "304,50,343,83",
          shape: "rect",
        },
        {
          alt: "output2",
          title: "output2",
          coords: "252,44,294,79",
          shape: "rect",
        },
        {
          alt: "output3",
          title: "output3",
          coords: "206,46,243,80",
          shape: "rect",
        },
        {
          alt: "output4",
          title: "output4",
          coords: "155,47,196,81",
          shape: "rect",
        },
      ],
      areaClicked: null,
  ...
  methods: {
    ...
    openInstructionForm(index) {
      ...
      if (index > 0) {
        ...
        this.assignmentExternalComponent = this.getSubValue(
          index,
          "externalComponent",
        );
    ...
    moveInstructionUp(key) {
      ...
      if (index > 0) {
        // Ensure there is a previous item to swap with
    ...
    submitAssignment() {
      ...
      if (
        ...
        this.assignmentName === "" ||
        this.getInstructionAmount === 0
      ) {
        return useToast().error(
          "Please complete the assignment name or create the instruction atleast one.",
        );
      }
      ...
      if (this.isExist) {
        this.$http
          .put("/modify/" + this.assignment_id, qs.stringify(data), config)
          .then((response) => {
        ...
        this.$http
          .post("create", qs.stringify(data), config)
          .then((response) => {
    ...
    getStepFunctionDetails(index) {
      ...
      let stepInfo = "";
      if (step) {
        console.log(`Details of instructions number ${index}:`);
    ...
    objectToMap(obj) {
      ...
      Object.keys(obj).forEach((key) => {
        ...
        /*
    console.log(
          `Key: ${key}, Type of value: ${typeof value}, Value: ${JSON.stringify(value, null, 2)}`,
        );
    */
