<template>
  <div class="align-self-center;"> 
        ...
        <div class="columns-lg" v-if="detailView">
        ...
        <div class="columns-lg" v-else>
            ...
            <div>
                <div className="URL existed" v-if="mobileAppURL !== '' && mobileAppURL !== false ">
                    ...
                    <p>
                    The assignment's is presence,
                    You can try the assignment on the button.
                    </p>
                </div>
                <div className="noURLDisplayed" v-else>
                    <img class="object-none w-325 h-325" src="/error.jpg"/>
                    <p> 
                        This assignment don't have app's URL yet,
                        Please wait the author to add this app later.
                    </p>
                </div>
            ...
            <div className="side-menu">
                <!-- if assignment url is presenced. -->
