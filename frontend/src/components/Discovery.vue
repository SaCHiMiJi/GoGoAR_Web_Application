<template>
  <section>
    <div v-show="assignments.length > 0" class="py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      <!-- Introduction text -->
      <p class="text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 pb-8">
      ...
      <div class="max-w-md mx-auto">   
        ...
        <div class="relative mb-4">
          ...
          <input v-model="inputFilter" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Filter By Name or Creator..." required :readonly="nameFilter || creatorFilter" />
        </div>
        <!-- Filter operations buttons -->
        <div v-show="!nameFilter && !creatorFilter">
          <button @click="setNameFilter()" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Name</button>
          <button @click="setCreatorFilter()" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Creator</button>
        </div>
        <div v-show="nameFilter" class="flex justify-center mx-auto">
          <button @click="clearFilter()" class="flex justify-center items-center text-white bg-red-700 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 hover:text-black">
            <span>Name</span>
            <svg class="w-4 h-4 ml-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
      ...
      <div class="flex justify-end rounded-md" role="group">
        <button @click="isTableView = true;" class="p-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-s-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path d="M1 4h14v2H1zM1 7h14v2H1zM1 10h14v2H1z"/>
          </svg>
        </button>
        <button @click="isTableView = false;" class="p-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-e-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    ...
    <!-- Table view -->
    <div v-if="isTableView" class="py-2 mx-auto max-w-screen-2xl text-center lg:py-8">
          ...
          <thead class="text-l text-white uppercase bg-[#322653]">
            ...
            <tr>
                <th scope="col" class="px-6 py-3">
                  <div  @click="sortAscending('name', !isNameAscend)" class="p-2 flex items-center hover:text-[#322653] hover:bg-white">
                    Name
                    <a>
                ...
                <th scope="col" class="px-6 py-3">
                    <div @click="sortAscending('creator', !isCreatorAscend)" class="p-2 flex items-center hover:text-[#322653] hover:bg-white">
                      Creator
                      <a>
                        <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
                ...
                <th scope="col" class="px-6 py-3">
                    <div @click="sortAscending('date', !isDateAscend)" class="p-2 flex items-center hover:text-[#322653] hover:bg-white">
                      Modified
                      <a>
                        <svg class="w-3 h-3 ms-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M8.574 11.024h6.852a2.075 2.075 0 0 0 1.847-1.086 1.9 1.9 0 0 0-.11-1.986L13.736 2.9a2.122 2.122 0 0 0-3.472 0L6.837 7.952a1.9 1.9 0 0 0-.11 1.986 2.074 2.074 0 0 0 1.847 1.086Zm6.852 1.952H8.574a2.072 2.072 0 0 0-1.847 1.087 1.9 1.9 0 0 0 .11 1.985l3.426 5.05a2.123 2.123 0 0 0 3.472 0l3.427-5.05a1.9 1.9 0 0 0 .11-1.985 2.074 2.074 0 0 0-1.846-1.087Z"/>
                ...
                <td class="px-6 py-4 text-right">
                  <div class="flex justify-end mt-4">
                    <router-link :to="{ path: '/assignmentview/' + assignment._id }">
                      <div class="w-[62px] h-[62px] p-4 text-sm font-medium flex items-center text-black bg-white border border-black rounded-lg hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-800">
    ...
    <div v-else class="grid gap-4 m-10" style="grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));">
      <div class="form-row align-items-center text-left" v-for="assignment in assignments" :key="assignment._id" v-show="isValidFilter(assignment.assignment_name, assignment.creator_name)">
        <div class="max-w-sm h-full p-6 bg-white border border-gray-200 rounded-lg shadow">
          <h2>{{ assignment.assignment_name }}</h2>
          
          <p class="font-normal text-sm text-gray-700">{{ assignment.description }}</p>
...
export default {
  ...
  methods: {
    ...
    isValidFilter(name, creator) {
      ...
      if(this.nameFilter && nameFilts.includes(this.nameFilter.toLowerCase().replace(/\s/g, ''))) {
        return true;
      } else if(this.creatorFilter && creatorFilts.includes(this.creatorFilter.toLowerCase().replace(/\s/g, ''))) {
        return true;
