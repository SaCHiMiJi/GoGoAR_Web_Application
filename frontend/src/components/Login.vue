        ...
        <div class="w-full bg-white rounded-lg shaded md:mt-0 sm:max-w-md xl:p-0">
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" @submit.prevent action="#">
                  ...
                  <button @click="loginSubmission()" type="submit" class="border border-black w-full text-dark bg-white hover:bg-gray-600 hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
