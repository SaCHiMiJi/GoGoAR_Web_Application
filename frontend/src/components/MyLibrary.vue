...
<section>
    ...
    <div v-if="assignments.length==0" class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
    ...
    <div v-else class="py-4 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      <div class="max-w-md mx-auto">   
        ...
        <div class="relative mb-4">
          ...
          <input v-model="inputFilter" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Filter By Name..." required :readonly="nameFilter"/>
        </div>
        <!-- Filter operations buttons -->
        <div v-show="!nameFilter" class="flex justify-center mx-auto">
          <button @click="setNameFilter()" 
            class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2">Name</button>
        </div>
        <div v-show="nameFilter" class="flex justify-center mx-auto">
      ...
      <div v-if="isTableView" class="py-2 mx-auto max-w-screen-2xl text-center lg:py-8">
        <div class="relative overflow-x-auto sm:rounded-lg">
          <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <!-- Content -->
            <tbody>
              <tr class="bg-white border-b" v-for="assignment in assignments" :key="assignment._id" v-show="isValidFilter(assignment.assignment_name)">
                <!-- Name -->
      ...
      <div v-else class="grid grid-cols-4 gap-4 m-10">
        <div class="form-row align-items-center text-left" v-bind:key="assignment" v-for="assignment in assignments" v-show="isValidFilter(assignment.assignment_name)">
          ...
          <div class="max-w-sm h-full p-6 bg-white border border-gray-200 rounded-lg shadow">
            ...
            <!-- URL -->
            <p class="font-normal text-gray-500" v-if="assignment.mobileapp_url != null">
