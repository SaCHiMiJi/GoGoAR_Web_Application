<template>
  <section class="min-h-screen">
    <div class="mx-auto min-w-sm max-w-5xl pt-[24px]">
      <div class="mx-[16px]">
        ...
        <ul>
          ...
          <li>
            <p><strong>Application</strong> refers to GoGo AR, the software program provided by the Company.</p>
          </li>
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GoGo AR.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to GoGo AR, accessible from <a href="https://gogo-ar.tlic.cmu.ac.th" rel="external nofollow noopener" target="_blank">https://gogo-ar.tlic.cmu.ac.th</a></p>
          </li>
          <li>
        ...
        <h1>Contact Us</h1>
        <ul>
          <li>Email: vrlab.cmu@gmail.com</li>
        </ul>
      </div>
    </div>
  </section>
...
<style scoped>
h1 {
  font-size: 1.875rem; /* ~30px (Tailwind's text-3xl) */
  font-weight: bold;
  margin-top: 1.5rem;
  margin-bottom: 1rem;
}
...
a {
  color: #1d4ed8; /* similar to Tailwind's blue-700 */
