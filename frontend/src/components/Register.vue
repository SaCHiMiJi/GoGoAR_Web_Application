<template>
  <div>
    <section  class="min-h-screen bg-gray-50">
      ...
      >
        <div
          class="w-full bg-white rounded-lg shaded md:mt-0 sm:max-w-md xl:p-0"
        >
          <div
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M10 3c-4.418 0-8 3.582-8 8s3.582 8 8 8 8-3.582 8-8-3.582-8-8-8zm0 14a6 6 0 110-12 6 6 0 010 12z"
                      />
                    ...
                    >
                      <path
                        d="M3.055 13.045A8 8 0 0116.945 6.055L10 10 3.055 13.045zm.666 1.665A10 10 0 0017.278 8.278L10 10 3.721 16.721zM10 8a2 2 0 100 4 2 2 0 000-4z"
                      />
                    </svg>
                  </button>
                </div>
      ...
      >
        ...
        <button
          @click="$router.replace({ path: '/signin' })"
          class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Login
        </button>
      </div>
        ...
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-4 md:p-5 text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-500">
              Are you sure you want to Sign-up with these information?
            </h3>
            <button
              @click="register"
              type="button"
    ...
    validateRegister() {
      ...
      if (this.password !== this.confirmaryPassword) {
        return this.errorCard(
          "Your confirmary password is not the same, please retry again.",
        );
      }
