  ...
  <div v-if="isRegistered === false" class="flex flex-col items-center justify-center px-6 py-4 mx-auto md:h-screen lg:py-0">
      <div class="w-full bg-white rounded-lg shaded md:mt-0 sm:max-w-md xl:p-0">
          <div class="flex items-center p-4 text-2xl font-semibold bg-[#322653] text-gray-300 rounded-xl">
              <v-lazy-image class="mx-auto w-12 h-12" src="/weblogo.svg" alt="logo"/>
          </div>
		 ...
		 <!-- username -->
                  <div>
                      ...
                      <input v-model="username" type="text" name="username" id="username" maxlength="30" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="yourname" required="">
                  </div>
		  <!-- email -->
		  <div>
